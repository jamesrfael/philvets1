export const notificationData = [
  {
    ...
    message: 'The stock level for Product A has fallen below the minimum threshold of 15 units. Please review and reorder as necessary.',
  ...
  },
  {
    ...
    message: 'A new order has been received from Customer XYZ. Order ID: 12345.',
  ...
  },
  {
    ...
    message: 'Your shipment for Order ID: 12345 is out for delivery and is expected to arrive on 2024-09-20.',
  ...
  },
  {
    ...
    message: 'The physical inventory count for the warehouse has been completed. Review the results for discrepancies.',
  ...
  },
  {
    ...
    message: 'The system will undergo maintenance on 2024-09-20 from 2:00 AM to 4:00 AM. Please plan accordingly.',
  ...
  },
  {
    ...
    message: 'Product B is nearing its expiration date. The product will expire on 2024-09-25.',
  ...
  },
  {
    ...
    message: 'A transaction failed during processing. Please check the logs for more details.',
  ...
  },
  {
    ...
    message: 'A compliance issue has been detected in the current inventory. Immediate action required.',
  ...
  },
  {
    ...
    message: 'A stock adjustment has been made for Product C. Review the changes and verify if necessary.',
