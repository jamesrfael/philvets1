...
import styled from "styled-components"; // Ensure this import matches the file name exactly
...
import CardTotalCustomerOrder from "../../components/CardsData/CardTotalCustomerOrder"; // Card component
import Button from "../../components/Layout/Button"; // Import the Button component
import { customerOrders } from "../data/CustomerOrderData"; // Import the customer data
  ...
  return (
    <MainLayout>
      ...
      {selectedOrder && (
        ...
        /> // Updated to use CustomerOrderDetailsModal
      )}
