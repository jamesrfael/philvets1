...
import { superAdminSidebarItems, adminSidebarItems, staffSidebarItems } from "./sidebarItems";
...
const Sidebar = ({ isOpen, onClose, isAdmin, isSuperAdmin }) => {
  ...
  const sidebarItems = isSuperAdmin ? superAdminSidebarItems : isAdmin ? adminSidebarItems : staffSidebarItems;
