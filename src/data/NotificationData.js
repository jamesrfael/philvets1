export const notificationData = [
  {
    ...
    timestamp: "October 29, 2024 - 08:30:00 AM",
  ...
  // Additional notifications with different dates
  {
    id: 11,
    title: "Annual Review - Vendor Performance",
    message: "The annual performance review for vendors will be conducted on October 22, 2024.",
    timestamp: "October 22, 2024 - 09:00:00 AM",
    action: { label: "View Details", link: "/reviews/vendor-performance" },
    priority: "Medium",
  },
  {
    id: 12,
    title: "New Product Launch - Flea Prevention for Kittens",
    message: "A new product for Flea Prevention in Kittens has been launched. Check it out now!",
    timestamp: "October 22, 2024 - 11:30:00 AM",
    action: { label: "Explore Product", link: "/products/flea-prevention-kittens" },
    priority: "High",
  },
  {
    id: 13,
    title: "Expired Products Notification",
    message: "Several products have expired. Please take immediate action.",
    timestamp: "October 23, 2024 - 10:00:00 AM",
    action: { label: "Review Expired Products", link: "/products/expired" },
    priority: "High",
  },
  {
    id: 14,
    title: "Training Session Scheduled",
    message: "A training session on new inventory management software is scheduled for October 24, 2024.",
    timestamp: "October 24, 2024 - 01:00:00 PM",
    action: { label: "Register Now", link: "/training/register" },
    priority: "Medium",
  },
  {
    id: 15,
    title: "Weekly Summary - Inventory Status",
    message: "The weekly inventory status summary will be available on October 25, 2024.",
    timestamp: "October 25, 2024 - 03:00:00 PM",
    action: { label: "View Summary", link: "/inventory/summary" },
    priority: "Low",
  },
];
