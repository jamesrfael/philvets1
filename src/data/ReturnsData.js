...
const returnsData = [
  {
    ...
    type: "Purchase",
    status: "Processing",
    description: "Customer returned the product due to a manufacturing defect in the electronic components.",
    products: [
  ...
  },
  {
    ...
    type: "Sales",
    status: "Completed",
    description: "Returned due to incorrect size of the apparel items delivered.",
    products: [
  ...
  },
  {
    ...
    type: "Purchase",
    status: "Processing",
    description: "Products did not match the description provided on the website.",
    products: [
  ...
  },
  {
    ...
    type: "Sales",
    status: "Pending",
    description: "Customer found a better deal elsewhere and decided to return the purchased items.",
    products: [
  ...
  },
  {
    ...
    type: "Purchase",
    status: "Completed",
    description: "The clothing items had minor defects and did not meet customer expectations.",
    products: [
